...
const Intro = () => {
  return (
    <div className='bg-primary h-[calc(100%)] flex justify-center items-center gap-3 pt-16 xl:pt-0 relative overflow-hidden' id="home">
      ...
      <div className="about max-w-[900px] mx-auto flex flex-col justify-center items-center gap-3  ">
        ...
        <iframe className='absolute top-36 -right-36 inline-block 
         h-32 opacity-30' src="https://lottie.host/embed/c4cc4460-876e-432f-b424-2b4396d3075b/mtaxKKAoiY.json"></iframe>
